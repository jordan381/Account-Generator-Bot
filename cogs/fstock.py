...
class fstock(commands.Cog):
    ...
    async def fstock(self, ctx):
        ...
        embed.set_footer(text="Stock Loading..", icon_url="https://cdn.discordapp.com/attachments/1204244617869000788/1204249308237402162/icon.png?ex=65d40b90&is=65c19690&hm=42115bccb811f86d7a9cdbcb686a2f1c2a5be6633e04f712da3765d6da475e03&")
